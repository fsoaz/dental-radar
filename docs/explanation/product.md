...
> Companion docs: [architecture.md](./architecture.md) · [roadmap.md](../internal/roadmap.md).
...
| 7 | MVP Roadmap | [internal/roadmap.md](../internal/roadmap.md) |
| 8 | Sprint Breakdown | [internal/roadmap.md](../internal/roadmap.md) |
| 9 | User Stories | this file |
| 10 | Technical Tasks | [internal/tasks/](../internal/tasks/) |

**Implementation status:** MVP (Phases 1–7) complete as of 2026-06-19. QA remediation 2026-07-27 closed critical correctness/security gaps — release call **pilot with reservations**. See [docs/README.md](../README.md) and [qa_report_2026-07-27.md](../internal/qa_report_2026-07-27.md) §9.
...
Detects the signals below and attaches a weight to each. Weights are **config-driven** (see [architecture.md → Scoring config](./architecture.md#3-scoring-engine--configuration)).
...
Format: **As a `<role>`, I want `<capability>` so that `<value>`.** Each story lists acceptance criteria (AC). Stories link to technical tasks in [`internal/tasks/`](../internal/tasks/).

### Epic A — Clinic Discovery  *([phase-2](../internal/tasks/phase-2-discovery.md))*
...
### Epic B — Clinic Profile  *([phase-2](../internal/tasks/phase-2-discovery.md))*
...
### Epic C — Signal Detection  *([phase-3](../internal/tasks/phase-3-signals.md))*
...
### Epic D — Scoring & Ranking  *([phase-4](../internal/tasks/phase-4-scoring.md))*
...
### Epic E — AI Enrichment  *([phase-5](../internal/tasks/phase-5-ai-enrichment.md))*
...
### Epic F — Dashboard  *([phase-6](../internal/tasks/phase-6-dashboard.md))*
...
### Epic G — Foundation & Deployment  *([phase-1](../internal/tasks/phase-1-foundation.md), [phase-7](../internal/tasks/phase-7-deployment.md))*
