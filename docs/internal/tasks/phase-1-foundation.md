...
## Tasks
- [x] Init repo layout (`backend/`, `frontend/`, `docker-compose.yml`, `.github/workflows/ci.yml`) per [architecture.md](../../explanation/architecture.md#7-folder-structure-deliverable-6).
...
- [x] Alembic init; initial migration creating all tables; seed `scoring_config` v1. *(The seed now lives only in migration `0001`; the unused `scoring_defaults.yaml` was removed in 2026-09.)*
